<?php
    ...
    $statement = $mysqli->prepare("select event_name, event_date, event_time, event_id, event_tag from events where event_month = ? and event_year = ? and username = ?");
    $statement->bind_param('iis', $month, $year, $username);
    $statement->execute();
